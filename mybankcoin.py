...
class Bank:
    ...
    def observe_coin(self, coin):
        ...
        last_observation_num_tranfers = len(last_observation.transfers)
        assert last_observation.transfers == coin.transfers[:last_observation_num_tranfers]
